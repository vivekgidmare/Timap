...
@Kroll.proxy(creatableInModule = MapModule.class, propertyAccessors = {
		...
		MapModule.PROPERTY_USER_LOCATION_BUTTON, TiC.PROPERTY_MAP_TYPE,
		TiC.PROPERTY_REGION, TiC.PROPERTY_ANNOTATIONS, TiC.PROPERTY_ANIMATE,
		MapModule.PROPERTY_TRAFFIC, TiC.PROPERTY_ENABLE_ZOOM_CONTROLS })
public class ViewProxy extends TiViewProxy {
	...
	public void addAnnotations(AnnotationProxy[] annotations) {
		if (TiApplication.isUIThread()) {
			...
			TiMessenger.sendBlockingMainMessage(
					getMainHandler().obtainMessage(MSG_ADD_ANNOTATIONS),
					annotations);
		}
	}
	...
	public void removePreloadAnnotation(Object annotation) {
		if (annotation instanceof AnnotationProxy
				&& preloadAnnotations.contains(annotation)) {
